...
$config['APIUsername'] = $config['Sandbox'] ? 'merchant_api1.paanduv.com' : 'trippedswitches_api1.gmail.com';

// $config['APIPassword'] = $config['Sandbox'] ? '3TWZ4CZE55SQZ6LG' : 'MWTN7RAKEC2K8759';
$config['APIPassword'] = $config['Sandbox'] ? 'ZUN9CTJ5XZQBV488' : 'MWTN7RAKEC2K8759';

$config['APISignature'] = $config['Sandbox'] ? 'AKt2um9iXDK4KDM95I7LXEI3r-HRAae8iu8ypJTs0O8QSJKR4mKn3QzS' : 'Ag4Z26aBAOzaklnCwFn6P2MOkXJRA9b1-zoATQbgxLF7AjdhcDDrBcDr';
