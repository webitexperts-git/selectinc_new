              ...
              <div class=" col-md-12">
                 <div class="table-responsive">
                   <table class="table">
                      ...
                      <tbody>
                         <tr>
                           <td><?php echo $link->test_link ?></td>
                           <td><?php echo $link->test_text ?></td>
                           <th><button  type='button' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#modalEditData' 
                           
                          data-title="<?php echo base64_encode($link->test_link); ?>"  
                          data-text="<?php echo base64_encode($link->test_text); ?>"  
                          onclick=" $('#txeditttitle').val(atob($(this).attr('data-title'))); $('#testtext').val(atob($(this).attr('data-text'))); 
                          "><i class="fa fa-pencil-square-o"></i> EDIT</button></th>
...
<div id="modalEditData" class="modal fade" role="dialog">
      ...
      <div class="modal-body">
         <form method="POST" id="FormEditData" name="FormEditData" enctype="multipart/form-data">
            <div class="form-group">
             ...
             <div class="form-group">
              <label for="title">Test Text:</label>
              <textarea  class="form-control" id="testtext" name="testtext"></textarea>
            </div>
 ...
 <script type="text/javascript"> 
    ...
    $('#FormEditData').on('submit', function(e){       
        ...
        // $('#myloader').show();
        $.ajax({
            url: '<?php echo base_url('admin/paanduv-test-link'); ?>',
            type: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
