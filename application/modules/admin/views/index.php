                        ...
                        <input type="hidden" name="txtcounttotal" id="txtcounttotal" value="<?php echo $totalcount; ?>">
                          ...
                          ?>
                            ...
                            <tr class="<?php echo $scls; ?>">
                                ...
                                <td>
                                  <a href="<?php echo $transactionUrl; ?>" class="btn btn-primary btn-sm btn-block"><i class="fa fa-eye"></i> TRANSACTION</a>
                                </td>
                                ...
                                <!-- <td></td> -->
                                <!-- <td><button data-id="<?php echo $user->id; ?>" data-active="<?php echo $user->active; ?>" data-toggle="modal"  data-target="#modalAccountActive"class="accountbtn <?php echo $acls; ?>"><?php echo $active  ?></button></td> -->
                                
                                <!--<td> <a href="<?php echo $redirect_car_list; ?>" class="btn btn-warning input-sm"><i class="fa fa-car"></i> CAR LIST</a></td>-->
                                ...
                                <td class="text-center">
                                  ...
                                  if($user->user == 1){
                                    if($user->test_pass == 1){
                                    ?>
                                    <img style="height: 40px;" src="<?php echo base_url('assets/paanduvTest.png') ?>">
                                    <?php
                                    }
                                    else{
                                    ?>
                                    <!-- <?php echo $testPass; ?> -->
                                     ...
                                     <a class="btn btn-sm btn-warning" data-id="<?php echo $user->id  ?>" href="" data-toggle="modal" data-target="#modalTestUserPassed" onclick="$('#testuserid').val($(this).attr('data-id'))"> NOT TESTED </a> 
                                    <?php
                                    }
                                  }
                                  else if($user->user == 2){
                                ...
                                <td>
                                  ...
                                  else if($user->approvel == 2){
                                  ?>
                                  <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalProfileApproveAccount" data-id="<?php echo $user->id; ?>" onclick="$('#approveusrid').val($(this).attr('data-id'))"> REQUESTED </button>
                                  <?php
                                  }
                                  else{
                                  ?>
