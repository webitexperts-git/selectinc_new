                 ...
                 <div class="table-responsive">
                   <table class="table">
                      <thead>
                         <tr>
                           <th>SERVICE FEE</th>
                           <th><?php echo $service_fee->service_fee ?> %</th>
                           <th><button  type='button' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#modalEditData' 
                           
                          data-title="<?php echo base64_encode($service_fee->service_fee); ?>"  
                          onclick=" $('#txeditttitle').val(atob($(this).attr('data-title'))); 
...
<div id="modalEditData" class="modal fade" role="dialog">
      ...
      <div class="modal-body">
         <form method="POST" id="FormEditData" name="FormEditData" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="number" step="any" min="0" class="form-control" id="txeditttitle" name="txeditttitle" >
            </div>

              <div id="reteditmsg"></div>
              <div class="text-center">
                <button type="submit" class="btn btn-primary text-uppercase">SAVE LINK</button>
              </div>
          </form>
      </div>
    </div>
 ...
 <script type="text/javascript"> 
    ...
    $('#FormEditData').on('submit', function(e){       
        ...
        // $('#myloader').show();
        $.ajax({
            url: '<?php echo base_url('admin/save-paanduv-service-fee'); ?>',
            type: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
