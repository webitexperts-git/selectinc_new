  ...
  <div class="page-title">
    <div style="width: 100%">
      <h1 class="text-uppercase"> 
         Industry
          <button data-toggle="modal" data-target="#modalAddData" class="btn btn-sm btn-primary pull-right"> ADD INDUSTRY </button>
      </h1>
    </div>
  </div>
  <div class="row">
...
<div id="modalEditData" class="modal fade" role="dialog">
 ...
 <script type="text/javascript"> 
    $('#FormAddData').on('submit', function(e){       
        ...
        // $('#myloader').show();
        $.ajax({
            url: '<?php echo base_url('admin/add-industry'); ?>',
            type: "POST",
    ...
    $('#FormEditData').on('submit', function(e){       
        ...
        // $('#myloader').show();
        $.ajax({
            url: '<?php echo base_url('admin/save-industry'); ?>',
            type: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#FormDeleteData').on('submit', function(e){       
      ...
      // $('#myloader').show();
      $.ajax({
          url: '<?php echo base_url('admin/delete-industry'); ?>',
          type: "POST",
          data: new FormData(this),
          contentType: false,
          cache: false,
