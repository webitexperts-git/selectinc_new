    ...
    <div style="width: 100%">
      <h1 class="text-uppercase"> 
         Language Proficiency
          <button data-toggle="modal" data-target="#modalAddData" class="btn btn-sm btn-primary pull-right"> ADD LANGUAGE PROFICIENCY</button>
      </h1>
    </div>
  </div>
  <div class="row">
              ...
              <div class=" col-md-12">
                 <div class="table-responsive">
                   <table class="table">
                      ...
                      <?php 
                    if(!empty($language_proficiencys)){
                      $count = 0;
                      foreach ($language_proficiencys as $data) {
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Language Proficiency</h4>
      </div>
...
<div id="modalEditData" class="modal fade" role="dialog">
  <div class="modal-dialog"> 
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Edit Language Proficiency </h4>
      </div>
      <div class="modal-body">
 ...
 <script type="text/javascript"> 
    $('#FormAddData').on('submit', function(e){       
        ...
        // $('#myloader').show();
        $.ajax({
            url: '<?php echo base_url('admin/add-language-proficiency'); ?>',
            type: "POST",
    ...
    $('#FormEditData').on('submit', function(e){       
        ...
        // $('#myloader').show();
        $.ajax({
            url: '<?php echo base_url('admin/save-language-proficiency'); ?>',
            type: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#FormDeleteData').on('submit', function(e){       
      ...
      // $('#myloader').show();
      $.ajax({
          url: '<?php echo base_url('admin/delete-language-proficiency'); ?>',
          type: "POST",
          data: new FormData(this),
          contentType: false,
          cache: false,
