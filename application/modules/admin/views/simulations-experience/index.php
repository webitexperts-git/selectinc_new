  ...
  <div class="page-title">
    <div style="width: 100%">
      <h1 class="text-uppercase"> 
          ...
          <button data-toggle="modal" data-target="#modalAddData" class="btn btn-sm btn-primary pull-right"> ADD SIMULATIONS EXPERIENCE </button>
      </h1>
    </div>
  </div>
  <div class="row">
              ...
              <div class=" col-md-12">
                 <div class="table-responsive">
                   <table class="table">
                      ...
                      <?php 
                    if(!empty($simulations_experiences)){
                      $count = 0;
                      foreach ($simulations_experiences as $data) {
...
<div id="modalEditData" class="modal fade" role="dialog">
 ...
 <script type="text/javascript"> 
    $('#FormAddData').on('submit', function(e){       
        ...
        // $('#myloader').show();
        $.ajax({
            url: '<?php echo base_url('admin/add-simulations-experience'); ?>',
            type: "POST",
    ...
    $('#FormEditData').on('submit', function(e){       
        ...
        // $('#myloader').show();
        $.ajax({
            url: '<?php echo base_url('admin/save-simulations-experience'); ?>',
            type: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#FormDeleteData').on('submit', function(e){       
      ...
      // $('#myloader').show();
      $.ajax({
          url: '<?php echo base_url('admin/delete-simulations-experience'); ?>',
          type: "POST",
          data: new FormData(this),
          contentType: false,
          cache: false,
